package com.thayren.bmicontrol.tests.service;
...
import com.thayren.bmicontrol.services.UserService;
import com.thayren.bmicontrol.services.exceptions.ResourceNotFoundException;
import com.thayren.bmicontrol.tests.factory.UserFactory;
...
public class UserServiceTests {
	...
	void setUp() throws Exception {
		...
		Mockito.when(passwordEncoder.encode(ArgumentMatchers.anyString())).thenReturn(password); // Usado no método update.
